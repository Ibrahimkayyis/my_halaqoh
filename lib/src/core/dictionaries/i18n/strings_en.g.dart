...
class Translations implements BaseTranslations<AppLocale, Translations> {
	...
	late final TranslationsTentangAplikasiScreenEn tentangAplikasiScreen = TranslationsTentangAplikasiScreenEn._(_root);
...
class TranslationsAbsensiEn {
	...
	late final TranslationsAbsensiBarcodeScannerEn barcodeScanner = TranslationsAbsensiBarcodeScannerEn._(_root);
	late final TranslationsAbsensiMulaiAbsensiEn mulaiAbsensi = TranslationsAbsensiMulaiAbsensiEn._(_root);
}
...
class TranslationsDetailAbsensiHariIniEn {
	...
	late final TranslationsDetailAbsensiHariIniSessionsEn sessions = TranslationsDetailAbsensiHariIniSessionsEn._(_root);
}
...
class TranslationsTentangAplikasiScreenEn {
	TranslationsTentangAplikasiScreenEn._(this._root);
...
class TranslationsLaporanConfigEn {
	TranslationsLaporanConfigEn._(this._root);
...
class TranslationsAbsensiMulaiAbsensiEn {
	TranslationsAbsensiMulaiAbsensiEn._(this._root);
...
class TranslationsDetailAbsensiHariIniSessionsEn {
	TranslationsDetailAbsensiHariIniSessionsEn._(this._root);
...
class TranslationsLaporanConfigPdfEn {
	TranslationsLaporanConfigPdfEn._(this._root);
	...
	late final TranslationsLaporanConfigPdfPredikatEn predikat = TranslationsLaporanConfigPdfPredikatEn._(_root);
...
class TranslationsLaporanConfigPdfPredikatEn {
	TranslationsLaporanConfigPdfPredikatEn._(this._root);
