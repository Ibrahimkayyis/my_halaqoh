...
import '../cubits/laporan_hafalan_halaqoh_cubit.dart';
import '../cubits/laporan_hafalan_halaqoh_state.dart';

/// Modal bottom sheet for configuring and generating a whole-halaqoh Hafalan PDF report.
class LaporanKonfigurasiHafalanHalaqohSheet extends StatefulWidget {
  final HalaqohModel halaqoh;
  final List<SantriModel> santriList;
  final int initialMonth;
  final int initialYear;

  const LaporanKonfigurasiHafalanHalaqohSheet({
    super.key,
  ...
  static void show(
    ...
    showModalBottomSheet<void>(
      ...
      builder: (_) => BlocProvider(
        create: (_) => sl<LaporanHafalanHalaqohCubit>(),
        child: LaporanKonfigurasiHafalanHalaqohSheet(
          halaqoh: halaqoh,
  ...
  @override
  State<LaporanKonfigurasiHafalanHalaqohSheet> createState() =>
      _LaporanKonfigurasiHafalanHalaqohSheetState();
}

class _LaporanKonfigurasiHafalanHalaqohSheetState
    extends State<LaporanKonfigurasiHafalanHalaqohSheet>
  ...
  LaporanHafalanHalaqohConfig get _config => LaporanHafalanHalaqohConfig(
        halaqohName: widget.halaqoh.nama,
        guruNama: widget.halaqoh.guruNama,
        kelas: widget.halaqoh.kelas,
        range: _range,
  ...
  String get _filename {
    final slug = widget.halaqoh.nama.replaceAll(' ', '_');
    return 'Rekap_Hafalan_${slug}_${DateFormat('yyyyMMdd').format(DateTime.now())}.pdf';
  }
  ...
  Future<void> _pickDate(bool isStart) async {
    final picked = await showDatePicker(
      ...
      helpText: isStart
          ? t.laporanConfig.chooseStartDate
          : t.laporanConfig.chooseEndDate,
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<LaporanHafalanHalaqohCubit, LaporanHafalanHalaqohState>(
  ...
  Widget _buildConfigState(
    ...
    return Column(
      ...
      children: [
        Text(
          t.laporanConfig.titleHafalanHalaqoh,
          style: TextStyle(
            fontSize: 17.sp,
        ...
        SizedBox(height: 4.h),
        Text(
          t.laporanConfig.subtitleHafalanHalaqoh,
          style: TextStyle(
            fontSize: 12.sp,
        ...
        _HalaqohChip(
          halaqohName: widget.halaqoh.nama,
          guruNama: widget.halaqoh.guruNama,
          santriCount: widget.santriList.length,
          colors: colors,
        ),
          ...
          child: ElevatedButton(
            onPressed: isGenerating || !_isCustomValid
                ...
                : () => context
                    ...
                    .generatePdf(_config, widget.santriList),
      ...
      children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 2.h),
                    Text(
                      '${widget.halaqoh.nama} • ${widget.santriList.length} Santri',
                      style: TextStyle(
                        fontSize: 11.sp,
                        color: colors.textSecondary,
                        fontFamily: 'Poppins',
        ...
        Center(
          child: TextButton.icon(
            onPressed: () =>
                context.read<LaporanHafalanHalaqohCubit>().reset(),
            icon: Icon(
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 1.h),
                Text(
                  'Musyrif: $guruNama • $santriCount Santri',
                  style: TextStyle(
                    fontSize: 11.sp,
                    color: colors.textSecondary,
                    fontFamily: 'Poppins',
...
class _WeekChip extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final startStr = DateFormat('dd MMM', t.$meta.locale.languageCode).format(weekStart);
    final endStr = DateFormat('dd MMM yyyy', t.$meta.locale.languageCode).format(weekEnd);
    return Padding(
  ...
  Widget build(BuildContext context) => InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(10.r),
            border: Border.all(
              color: date != null ? colors.primary : colors.border,
          ...
          child: Row(
            children: [
              Icon(
                icon,
                size: 16.sp,
                color: date != null ? colors.primary : colors.textSecondary,
              ),
              SizedBox(width: 8.w),
              Expanded(
                child: Column(
...
class _PreviewBar extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final s = DateFormat('dd MMM yyyy', t.$meta.locale.languageCode).format(startDate);
    final e = DateFormat('dd MMM yyyy', t.$meta.locale.languageCode).format(endDate);
    ...
    return Container(
      ...
      child: Row(
        children: [
          Icon(Icons.date_range_rounded, size: 15.sp, color: colors.primary),
          SizedBox(width: 8.w),
          Expanded(
            child: Text(
              '$s – $e',
...
class _ActionButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return OutlinedButton.icon(
      onPressed: onTap,
      icon: Icon(icon, size: 18.sp, color: colors.textPrimary),
      label: Text(
        label,
        style: TextStyle(
          fontFamily: 'Poppins',
