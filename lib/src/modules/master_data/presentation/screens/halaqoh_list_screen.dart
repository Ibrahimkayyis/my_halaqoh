...
class _HalaqohListScreenState extends State<HalaqohListScreen> {
  ...
  final List<Map<String, dynamic>> _halaqohData = [
    {'name': 'Halaqoh 7R-1', 'kelas': '7', 'program': 'R', 'guru': 'Ust. Ahmad Rofiqi', 'santri': 10},
    {'name': 'Halaqoh 7R-2', 'kelas': '7', 'program': 'R', 'guru': 'Ust. Farhan Majid', 'santri': 9},
    {'name': 'Halaqoh 7T', 'kelas': '7', 'program': 'T', 'guru': 'Ust. Maulana Ilyas', 'santri': 10},
    {'name': 'Halaqoh 8R-1', 'kelas': '8', 'program': 'R', 'guru': 'Ust. Abdullah Faqih', 'santri': 11},
    {'name': 'Halaqoh 8R-2', 'kelas': '8', 'program': 'R', 'guru': 'Ust. Zainal Abidin', 'santri': 10},
    {'name': 'Halaqoh 8T', 'kelas': '8', 'program': 'T', 'guru': 'Ustdz. Siti Aminah, Lc.', 'santri': 9},
    {'name': 'Halaqoh 9R', 'kelas': '9', 'program': 'R', 'guru': 'Ust. Budi Santoso, M.Ag', 'santri': 12},
    {'name': 'Halaqoh 9T', 'kelas': '9', 'program': 'T', 'guru': 'Ustdz. Dewi Sartika, S.Hum', 'santri': 10},
    {'name': 'Halaqoh 10R', 'kelas': '10', 'program': 'R', 'guru': 'Ust. Rahmat Hidayat', 'santri': 8},
    {'name': 'Halaqoh 10T', 'kelas': '10', 'program': 'T', 'guru': 'Ust. Ahmad Fauzi', 'santri': 7},
    {'name': 'Halaqoh 11R', 'kelas': '11', 'program': 'R', 'guru': 'Ustdz. Nurul Huda', 'santri': 9},
    {'name': 'Halaqoh 12T', 'kelas': '12', 'program': 'T', 'guru': 'Ust. Zainal Abidin', 'santri': 6},
  ];
  ...
  void _onEdit(int index) {
    ...
    // Navigate to AddHalaqohScreen (in edit mode) with pre-filled data
    // For now, just navigate to AddHalaqohRoute
    context.router.push(const AddHalaqohRoute());
  }
      ...
      body: Column(
        children: [
          ...
          DataSearchBar(
            ...
            countText: t.halaqoh.showCount(count: _filteredData.length.toString()),
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return HalaqohCard(
                  ...
                  santriCount: t.halaqoh.santriCount(count: item['santri'].toString()),
