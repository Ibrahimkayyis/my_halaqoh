...
/// Pengaturan Screen for Admin (Master Data) — language and theme settings.
/// Functionally identical to [PengaturanScreen] used by Guru.
@RoutePage()
class PengaturanMasterDataSettingsScreen extends StatelessWidget {
  const PengaturanMasterDataSettingsScreen({super.key});
