...
/// List tile for displaying a [SantriModel] in the santri picker screen.
class SantriPickerTile extends StatelessWidget {
  const SantriPickerTile({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    final isTakhassus = santri.program == 'T';
