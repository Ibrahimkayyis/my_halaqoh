...
class _EditProfileScreenState extends State<EditProfileScreen> {
  final _namaController = TextEditingController(text: 'Ustadz Kayyis');
  final _nipController = TextEditingController(text: '12345678');
  final _jabatanController = TextEditingController(text: 'Guru Halaqoh');
  final _nomorHpController = TextEditingController(text: '081234567890');
  final _emailController = TextEditingController(text: 'kayyis@myhalaqoh.com');
