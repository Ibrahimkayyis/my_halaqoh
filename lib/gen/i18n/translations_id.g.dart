...
class _TranslationsGuruDashboardId extends TranslationsGuruDashboardEn {
	...
	@override String get menuUtama => 'Menu Utama';
	@override String get myHalaqoh => 'My Halaqoh';
...
extension on TranslationsId {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'guruDashboard.myHalaqoh': return 'My Halaqoh';
			...
			case 'guruNav.myHalaqoh': return 'My Halaqoh';
			case 'guruNav.laporan': return 'Laporan';
